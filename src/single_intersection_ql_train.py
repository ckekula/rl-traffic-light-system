...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="../Network/single/routes.rou.xml",
    ...
    prs.add_argument(
        "-e", dest="epsilon", type=float, default=1.0, required=False, help="Epsilon.\n"
    )
    prs.add_argument(
        "-me",
        dest="min_epsilon",
    ...
    prs.add_argument(
        "-v", action="store_true", default=False, help="Print experience tuple.\n"
    )
    prs.add_argument(
        "-runs", dest="runs", type=int, default=50, help="Number of runs.\n"
    )
    args = prs.parse_args()
    out_csv = "./TrainingResults/single/training"
    env = SumoEnvironment(
        network="./Networks/single/single_intersection.net.xml",
        route_file="./Networks/single/routes.rou.xml",
        output_file=out_csv,
        sumo_gui=args.gui,
    ...
    ql_agent = QLAgent(
        starting_state=env.encode(initial_states),
    ...
    ynames = [
        ...
        "Fuel consumption rewards",
        "Passed cars rewars",
        "Noise emission rewards",
    ]
